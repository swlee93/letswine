...
import { articleStyles, fontStyles, fontStylesBold, liStylesDisc, red, sectionStyles, ulStyles } from './previewStyles';
      ...
      <article style={{ ...articleStyles }}>
        <div style={{ width: '100%' }}>
          ...
          <div style={{}}>
            ...
            <ul style={{ ...ulStyles }}>
              <li style={{ ...liStylesDisc }}>19세 이상 성인 이상일 경우, 본인인증 이후 구매 가능합니다.</li>
              <li style={{ ...liStylesDisc }}>사업자 회원, 19세 미만 청소년은 구매할 수 없습니다.</li>
            </ul>
            <p style={{ ...fontStyles }}>2. 픽업상품(스마트오더)에 대한 고지</p>
            <ul style={{ ...ulStyles }}>
              <li style={{ ...liStylesDisc }}>
